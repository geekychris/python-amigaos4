...
Usage:
    DH1:python-os4 DH1:pytests/examples/wiki.py Amiga
    DH1:python-os4 DH1:pytests/examples/wiki.py "Alan Turing"
    DH1:python-os4 DH1:pytests/examples/wiki.py python (programming language)
"""
