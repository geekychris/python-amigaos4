...
# wasm32-emscripten, wasm32-wasi, and amigaos do not support fork_exec
_can_fork_exec = sys.platform not in {"emscripten", "wasi", "amigaos", "amigaos4"}
...
if _mswindows:
    ...
    if _can_fork_exec:
        try:
            ...
            _waitpid = getattr(os, 'waitpid', None)
            _waitstatus_to_exitcode = getattr(os, 'waitstatus_to_exitcode', None)
